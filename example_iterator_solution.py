...
def sort_streams(streams, n_streams):
    ...
    pos_dict = {}
    # total_entity_count: To store sum of count of integers in each streams
    ...
    while sum(pos_dict.values()) < total_entity_count:
        ...
        # Loop through each streams and check the smallest integer at current position of the pointer
        for i in range(n_streams):
...
if __name__ == '__main__':
    ...
    # Converting the streams if iterator into list dtypes for easy operations
